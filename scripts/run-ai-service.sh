...
ALLOWED='^(LOG_LEVEL|AI_SERVICE_PORT|AI_SERVICE_HMAC_SECRET|AI_CORE_HMAC_SECRET|AI_STUB_MODEL_VERSION|OPENROUTER_API_KEY|OPENROUTER_BASE_URL|CLASSIFICATION_MODEL|CLASSIFICATION_BUDGET_SECONDS|RERANKING_BUDGET_SECONDS|RAG_BUDGET_SECONDS|COPILOT_BUDGET_SECONDS|AZURE_OPENAI_API_KEY|AZURE_OPENAI_ENDPOINT|AZURE_OPENAI_DEPLOYMENT|AZURE_OPENAI_API_VERSION|AZURE_OPENAI_EMBEDDING_API_KEY|AZURE_OPENAI_EMBEDDING_ENDPOINT|AZURE_OPENAI_EMBEDDING_DEPLOYMENT|AZURE_OPENAI_EMBEDDING_API_VERSION|EMBEDDING_DIM)='
